...
const PindahTangan = require("./pindahTangan")
...
PindahTangan.hasMany(RkbmutPemindahtanganan, {
    foreignKey : "kode_pindah_tangan"
})

RkbmutPemindahtanganan.belongsTo(PindahTangan, {
    foreignKey : "kode_pindah_tangan"
})
