...
const reftugasanjabRouter = require("./refTugasAnjab")
const reftugassubanjabRouter = require("./refTugasSubAnjab")
...
router.use("/tugas-anjab", reftugasanjabRouter)
router.use("/tugas-sub-anjab", reftugassubanjabRouter)
